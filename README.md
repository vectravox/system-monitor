...
Приложение отображает данные из 10 независимых источников. Каждый источник
работает в отдельном потоке, обновляя интерфейс без блокировки. Проект построен
на принципах DDD и чистой архитектуры.
...
Проект разделён на четыре слоя. Зависимости направлены внутрь — от внешних слоёв
к ядру.
...
- 10 источников данных (CPU, память, диск, сеть, температура, вентиляторы, пинг,
курсор, бинарный файл, случайные числа)
